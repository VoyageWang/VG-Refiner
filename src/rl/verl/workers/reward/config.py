...
class RewardConfig:
    ...
    def post_init(self):
        ...
        if self.val_reward_function is not None:
            ...
            if os.path.exists(self.val_reward_function):
                self.val_reward_function = os.path.abspath(self.val_reward_function)
            else:
                print(f"Validation reward function {self.val_reward_function} not found.")
                self.val_reward_function = None
